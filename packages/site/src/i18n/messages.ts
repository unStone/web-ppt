...
export const messageCatalogs = [homeMessages, editorMessages, sampleMessages, mediaMessages, chartMessages, toolMessages, shapeMessages, accessibilityMessages, appearanceMessages] as const;
