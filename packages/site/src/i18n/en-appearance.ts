export const appearanceMessages = {
  ...
  '三维网格投影保留矢量文字；材质和斜角为浏览器近似。': '3D mesh projection retains vector text; materials and bevels are browser approximations.',
  'Z 轴视角': 'Z rotation', '透视视野角': 'Field of view', '相机缩放（%）': 'Camera zoom (%)',
  '投影方式': 'Projection', '正交投影': 'Orthographic', '透视投影': 'Perspective', '来源相机预设': 'Original camera preset',
