...
export function mediaMarkup(spid: number, rect: InsertionRect): string {
  return `<p:pic><p:nvPicPr><p:cNvPr id="${spid}" name="音频"/><p:cNvPicPr/>
<p:nvPr>${mediaPropertiesMarkup('audio', 'rIdAudio', 'rIdMedia')}</p:nvPr></p:nvPicPr>
