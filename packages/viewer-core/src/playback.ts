import { transitionPreferredDirection, type Slide, type Transition } from '@web-ppt/core';

export { framesFor, playGroup } from './animation/play';
export type { PlayHandle } from './animation/play';

/**
 * 页切换的播放层。对象动画在 animation/。
 * 全部走 Web Animations API，不注入 CSS 关键帧，避免污染宿主页面样式。
 */
