...
export const EDIT_SAVE_OFFICE_ARTIFACTS = Object.freeze([
  ...
  Object.freeze({ file: 'v06-integration-patch.pptx', slides: 2 }),
  Object.freeze({ file: 'v06-integration-generated.pptx', slides: 2 }),
  ...
  Object.freeze({ file: 'theme-editing.pptx', slides: 1 }),
  Object.freeze({ file: 'layout-editing.pptx', slides: 2 }),
  Object.freeze({ file: 'master-editing.pptx', slides: 3 }),
]);
