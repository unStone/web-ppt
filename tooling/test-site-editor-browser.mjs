...
// 再多 1577B：揭开类补齐。
// 再多 1282B：圆形蒙版按宽高比取正方形、轮子按角度分帧、溶解改成细格。
// 再多 42B：伸展改成从边缘长出。本次官网构建实测 gzip 549041。
const activatedBudget = { raw: initialBudget.raw + 142_565, gzip: initialBudget.gzip + 39_192 };
