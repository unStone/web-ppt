...
const keys=['slideResize','commentEdit','chartDesign','chartexEdit','smartartEdit','cfb','oleEdit','inkEdit','regionMap','emfPlus','threeD','advancedRendering','pdf','video','portableClipboard','pptSave'];
